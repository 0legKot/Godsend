...
namespace Godsend.Migrations
{
    ...
    [Migration("20190114104036_ExtendedLocation")]
    partial class ExtendedLocation
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Godsend.Models.LinkCommentEntity<Godsend.Models.Article>", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Godsend.Models.LinkCommentEntity<Godsend.Models.Product>", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Godsend.Models.LinkCommentEntity<Godsend.Models.Supplier>", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Godsend.Models.LinkProductImage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Godsend.Models.LinkRatingEntity<Godsend.Models.Article>", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Godsend.Models.LinkRatingEntity<Godsend.Models.Product>", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Godsend.Models.LinkRatingEntity<Godsend.Models.Supplier>", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Godsend.Models.LinkSupplierImage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Godsend.Models.LinkCommentEntity<Godsend.Models.Article>", b =>
                {
                    b.HasOne("Godsend.Models.LinkCommentEntity<Godsend.Models.Article>", "BaseComment")
            ...
            modelBuilder.Entity("Godsend.Models.LinkCommentEntity<Godsend.Models.Product>", b =>
                {
                    b.HasOne("Godsend.Models.LinkCommentEntity<Godsend.Models.Product>", "BaseComment")
                        .WithMany("ChildComments")
                        .HasForeignKey("BaseCommentId");
            ...
            modelBuilder.Entity("Godsend.Models.LinkCommentEntity<Godsend.Models.Supplier>", b =>
                {
                    b.HasOne("Godsend.Models.LinkCommentEntity<Godsend.Models.Supplier>", "BaseComment")
                        .WithMany("ChildComments")
                        .HasForeignKey("BaseCommentId");
            ...
            modelBuilder.Entity("Godsend.Models.LinkProductImage", b =>
                {
                    b.HasOne("Godsend.Models.Image", "Image")
                        .WithMany()
                        .HasForeignKey("ImageId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Godsend.Models.Product", "Product")
                        .WithMany("LinkProductImages")
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
